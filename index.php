...
switch(operation) {
  ...
  $.ajax({url: microservice_url,data: { first_number: first_number, second_number: second_number, operation: operation },dataType: 'JSON',method: 'post',crossDomain: true,success: function(result){
